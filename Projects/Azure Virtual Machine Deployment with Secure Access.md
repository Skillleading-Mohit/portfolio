...
**`Architecture`**
Azure Resource Group → Virtual Network → Subnet → Network Security Group → Virtual Machine → Public IP → RDP/SSH Access \

**`Steps Performed`**
Created Resource Group and Virtual Network with subnet configuration
Deployed Windows Server VM in Azure using IaaS model
...
**`Tools Used`**
Azure Portal, Azure Virtual Machines, NSG, RDP, IIS Server, Azure Backup
**`Outcome`**
